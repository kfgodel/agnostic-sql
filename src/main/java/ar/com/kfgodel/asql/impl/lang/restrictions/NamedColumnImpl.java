...
public class NamedColumnImpl implements NamedColumn {
  ...
  @Override
  public QueryCondition isIn(SelectStatement subQuery) {
    return Internal.binaryOp(this, Operator.in(), Internal.asSubquery(subQuery));
  }
  ...
  @Override
  public QueryCondition isNotIn(SelectStatement subQuery) {
    return Internal.binaryOp(this, Operator.notIn(), Internal.asSubquery(subQuery));
  }
