    ...
    public void define() {
        describe("an agnostic create statement model", () -> {
            ...
            context().createModel(()->{
                ...
                createModel.addDeclaration(ColumnDeclarationModel.create(ColumnReferenceModel.create("diasPorLiquidar"), DataType.integer().parseModel()).withNullability(NotPlacedBeforeModel.create(NullReference.create().parseModel())));
                createModel.addDeclaration(ColumnDeclarationModel.create(ColumnReferenceModel.create("cantidad"), DataType.integer().parseModel()).withNullability(NotPlacedBeforeModel.create(NullReference.create().parseModel())).withDefaultValue(ExplicitValueModel.create(0)));
