    ...
    public void define() {
        ...
        describe("agnostic data types", () -> {
            it("have ansi translations", () -> {
                ...
                assertThat(ansiInterpreter.translate(TypeReference.create(DataType.booleanic()))).isEqualTo("boolean");
            });
            it("have sqlserver translations", () -> {
                ...
                assertThat(sqlserverInterpreter.translate(TypeReference.create(DataType.booleanic()))).isEqualTo("bit");
            });
            it("have hsqldb translations", () -> {
                ...
                assertThat(hsqlInterpreter.translate(TypeReference.create(DataType.booleanic()))).isEqualTo("bit");
            });
        });
